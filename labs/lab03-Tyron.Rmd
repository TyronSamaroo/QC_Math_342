...
set$F = list("Boomer" = strsplit("Gloria, Joan, Dorothy, Shirley, Betty, Dianne, Kay, Marjorie, Lorraine, Mildred", split = (",")[[1]]),
...
set$M = list("Boomer" = strsplit("Theodore, Bernard, Gene, Herbert, Ray, Tom, Lee, Alfred, Leroy, Eddie", split = (",")[[1]]),
...
which.min(num_errors)
min(num_errors)
num_errors[6]
threshhold = iris$Sepal.Length[which.min(num_errors)]

g = function(x){
  as.numeric( x > threshhold)
}
