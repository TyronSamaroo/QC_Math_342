...
w = perceptron_learning_algorithm(iris$Sepal.Length,y,w = 0)
...
#'
#' @param Xinput      TO-DO: 
#' @param y_binary    TO-DO: label data that we are trying to predict 
#' @param MAX_ITER    TO-DO: Max steps the algorithm will run 
#' @param w           TO-DO: Weights
#'
