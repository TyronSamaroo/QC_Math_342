...
iter = (1:length(in_sample_brier_by_iteration))
ggplot(data.frame(iter)) + geom_line(aes(iter, in_sample_brier_by_iteration, color= "red"))+  geom_line(aes(iter, oos_brier_by_iteration, color= "blue"))

ggsave("Lab9_Brier_Score.pdf")
```
